...
import com.example.pgh.Taxi.TaxiFacOrderMainActivity;
...
public class FoodFacOrderMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_food_fac_order_main);
		extra=getIntent().getExtras();
		
		email=null;
		email=extra.getString("email").trim();
		Toast.makeText(FoodFacOrderMainActivity.this, email, Toast.LENGTH_SHORT).show();
		...
		new FoodFacOrd().execute();
	}
	
	public class FoodFacOrd extends AsyncTask<Void,Void,AllResult>
	{
		...
		protected void onPreExecute() {
			...
			dialog = new ProgressDialog(FoodFacOrderMainActivity.this);
		...
		protected AllResult doInBackground(Void... params) {
			...
			AllResult result = api.getfoodFacord(email);
			return result;
		...
		protected void onPostExecute(AllResult result) {
			...
			{
				Toast.makeText(FoodFacOrderMainActivity.this, "Empty", Toast.LENGTH_SHORT).show();
			}
