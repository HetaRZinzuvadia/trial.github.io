...
public class WaterFacOrdMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_water_fac_ord_main);
		extra=getIntent().getExtras();
		
		email=null;
		email=extra.getString("email").trim();
		Toast.makeText(WaterFacOrdMainActivity.this, email, Toast.LENGTH_SHORT).show();
		...
		new WaterFacOrd().execute();
	}
	
	public class WaterFacOrd extends AsyncTask<Void,Void,AllResult>
	{
		...
		protected void onPreExecute() {
			...
			dialog = new ProgressDialog(WaterFacOrdMainActivity.this);
		...
		protected AllResult doInBackground(Void... params) {
			...
			AllResult result = api.getwaterFacord(email);
			return result;
		...
		protected void onPostExecute(AllResult result) {
			...
			{
				Toast.makeText(WaterFacOrdMainActivity.this, "Empty", Toast.LENGTH_SHORT).show();
			}
