...
public class LetsStart2Activity extends Activity 
{
			...
			protected void onCreate(Bundle savedInstanceState) {
				...
				setContentView(R.layout.activity_lets_start2);
		    ...
		    public void makeHTTPCall() {
		        ...
		        client.post(APIResources.POST_TAXI_IMAGE_UPDATE_URL,
